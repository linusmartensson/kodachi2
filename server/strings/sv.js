module.exports = (app) => {
    ...
    s("task.review_artist_alley.desc", "Tjohej! Det har kommit in en ansökan från {user.nickname} som du behöver ta ställning till!\nArtistAlley: {application.name}\nTyp:{application.type}\nTeamstorlek:{application.size}\nTillgänglighet:{application.schedule}\nBord:{application.tables}\n#{application.name}\n@({application.image})\n_\n{|application.desc}\n");
    s("task.review_vendor.desc", "Tjohej! Det har kommit in en ansökan som du behöver ta ställning till!\Försäljare: {application.name}\nTyp:{application.type}\nTeamstorlek:{application.size}\nTillgänglighet:{application.schedule}\nBord:{application.tables}\n#{application.name}\n@({application.image})\n_\n{|application.desc}\n");
